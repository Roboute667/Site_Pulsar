...
export function Hero() {
  ...
  return (
    <section className="hero-section relative h-screen flex flex-col overflow-hidden">
      ...
      {/* Bottom fade: smooth transition from hero into the rest of the page */}
      <div 
      ...
      <div className="relative z-20 flex-1 flex flex-col justify-between pt-16 pb-6">
        ...
        {/* Spacer: lets the pulsar breathe in the center */}
        <div className="flex-1" />

        {/* Bottom block: CTA + FCA + scroll indicator */}
        <div className="flex flex-col items-center space-y-5 px-4">
          ...
          {/* FCA Badge */}
          <motion.div 
            className="inline-flex items-center space-x-3 text-sm text-muted"
            variants={fadeInUp}
            initial="initial"
            animate="animate"
